...
class fetchdata:
    ...
    def run_job(self, input_command):
         ...
         print(input_command)
         type(input_command)
         command = "ethereumetl export_blocks_and_transactions --start-block %i --end-block %i --blocks-output %s --transactions-output %s --provider-uri %s".format(input_command)
